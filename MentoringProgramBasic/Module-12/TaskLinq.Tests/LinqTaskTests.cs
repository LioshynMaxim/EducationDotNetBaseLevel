...
namespace LinqTask.Tests
{
    ...
    public class Tests
    {
        ...
        {
            return LinqClassTask.Linq1(DataSource.Customers, limit).Count();
        }

        [Test]
        public void Linq1_NullSource_ThrowsArgumentNullException()
        {
            Assert.That(() => LinqClassTask.Linq1(null, 42).ToList(), Throws.ArgumentNullException);
        }

        [Test]
        public void Linq2_CustomersAndSuppliers_2CustomersHaveSuppliers()
        {
            var result = LinqClassTask.Linq2(DataSource.Customers, DataSource.Suppliers).ToList();
            ...
            foreach (var (customer, suppliers) in result)
            {
                ...
                {
                    Assert.That(supplier.City, Is.EqualTo(customer.City).IgnoreCase);
                    Assert.That(supplier.Country, Is.EqualTo(customer.Country).IgnoreCase);
                }
            }
        }
        ...
        {
            Assert.That(() => LinqClassTask.Linq2(null, null).ToList(), Throws.ArgumentNullException);
        }

        [Test]
        public void Linq2UsingGroup_CustomersAndSuppliers_2CustomersHaveSuppliers()
        {
            var result = LinqClassTask.Linq2UsingGroup(DataSource.Customers, DataSource.Suppliers).ToList();
        ...
        {
            Assert.That(() => LinqClassTask.Linq2UsingGroup(null, null).ToList(), Throws.ArgumentNullException);
        }
        ...
        {
            return LinqClassTask.Linq3(DataSource.Customers, limit).Count();
        }

        [Test]
        public void Linq3_NullCustomer_ThrowsArgumentNullException()
        {
            Assert.That(() => LinqClassTask.Linq3(null, 42).ToList(), Throws.ArgumentNullException);
        }

        [Test]
        public void Linq4_Customers_CustomersAndDateOfEntry()
        {
            var result = LinqClassTask.Linq4(DataSource.Customers).ToList();
        ...
        {
            Assert.That(() => LinqClassTask.Linq4(null).ToList(), Throws.ArgumentNullException);
        }

        [Test]
        public void Linq5_Customers_CustomersAndDateOfEntry()
        {
            var result = LinqClassTask.Linq5(DataSource.Customers).ToList();
        ...
        {
            Assert.That(() => LinqClassTask.Linq5(null).ToList(), Throws.ArgumentNullException);
        }
        ...
        public void Linq6_Customers_ReturnsFilteredCustomers()
        {
            ...
            var result = LinqClassTask.Linq6(DataSource.Customers).ToList();
        ...
        {
            Assert.That(() => LinqClassTask.Linq6(null).ToList(), Throws.ArgumentNullException);
        }
        ...
        public void Linq7_Customers_Returns5()
        {
            ...
            var result = LinqClassTask.Linq7(DataSource.Products);
        ...
        {
            Assert.That(() => LinqClassTask.Linq7(null).ToList(), Throws.ArgumentNullException);
        }
        ...
        public void Linq8_Products_ReturnsGroupedProducts()
        {
            ...
            var result = LinqClassTask.Linq8(DataSource.Products, cheap, middle, expensive).ToList();
        ...
        {
            Assert.That(() => LinqClassTask.Linq8(null, 42, 42, 42).ToList(), Throws.ArgumentNullException);
        }
        ...
        public void Linq9_Customers_ReturnsGroupedProducts()
        {
            ...
            var result = LinqClassTask.Linq9(DataSource.Customers).ToList();
        ...
        {
            Assert.That(() => LinqClassTask.Linq9(null).ToList(), Throws.ArgumentNullException);
        }

        [Test]
        public void Linq10_Suppliers_ReturnsAggregateString()
        {
            string result = LinqClassTask.Linq10(DataSource.Suppliers);
            Assert.That(result, Is.EqualTo("UKUSAJapanSpainBrazilSwedenGermanyAustralia").IgnoreCase);
        }

        [Test]
        public void Linq10_NullSuppliers_ThrowsArgumentNullException()
        {
            Assert.That(() => LinqClassTask.Linq10(null).ToList(), Throws.ArgumentNullException);
        }
